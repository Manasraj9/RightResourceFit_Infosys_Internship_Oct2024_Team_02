  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetching Message Count using userId
        const messageResponse = await axios.get(`http://localhost:1000/count/${userId}`); // Use userId instead of companyId
